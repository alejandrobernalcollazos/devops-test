...
# Create a new file for the database connection
...
cat << 'EOF' > /var/www/html/zealous.php
...
# Set permission for apache to write to /var/www/html
chown -R ec2-user:apache /var/www

# Set permission for group to write to /var/www/html
chmod 2775 /var/www
